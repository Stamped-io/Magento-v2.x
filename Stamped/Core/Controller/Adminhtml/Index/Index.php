...
class Index extends \Magento\Backend\App\Action
{
     ...
     */
    public function __construct(Context $context, \Magento\Store\Model\StoreManagerInterface $storeManager, PageFactory $resultPageFactory, \Magento\Framework\Image\Factory $imageFactory, \Magento\Catalog\Helper\Image $imgHelper, \Magento\Store\Model\App\Emulation $appEmulation)
    {
                ...
                try {
                    ...
                    foreach ($salesCollection as $order) {
                        ...
                        foreach ($products as $product) {
                            ...
                            $full_product = $this->_objectManager->get('Magento\Catalog\Model\ProductRepository')->getById($product->getProductId());
                            ...
                            if (!!$full_product->getId()) {
                                ...
                                if (count($parentIds) > 0) {
                                    $full_product = $this->_objectManager->get('Magento\Catalog\Model\ProductRepository')-> getById($parentIds[0]);
                                }
                                ...
                                try {
                                    ...
                                    $product_data['productUrl'] = $full_product2->getUrlInStore(array(
